...
next active sequence: final security tail closure, then AI/release-trust
```
...
2. Start ITER-059
3. Continue through ITER-060, ITER-061, ITER-062, ITER-063, and ITER-064 one row at a time
